...
class CourseClass:
    def __init__(self,root):
       ...
       #===title===
       title=Label(self.root,text="Manage course Details",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=10,relwidth=1,height=40)
       ...
       #=====widgets======
       lbl_courseName=Label(self.root,text="Course Name",font=("goudy old style",20,"bold"),bg="white").place(x=5,y=80)
       lbl_duration=Label(self.root,text="Duration",font=("goudy old style",20,"bold"),bg="white").place(x=5,y=120)
       lbl_charges=Label(self.root,text="Charge",font=("goudy old style",20,"bold"),bg="white").place(x=5,y=160)
       lbl_description=Label(self.root,text="Description",font=("goudy old style",20,"bold"),bg="white").place(x=5,y=200)
       ...
       txt_duration=Entry(self.root,textvariable=self.var_duration,font=("goudy old style",20,"bold"),bg="lightyellow").place(x=180,y=100,width=200)
       txt_charges=Entry(self.root,textvariable=self.var_charges,font=("goudy old style",20,"bold"),bg="lightyellow").place(x=180,y=140,width=200)
       self.txt_description=Text(self.root,font=("goudy old style",20,"bold"),bg="lightyellow")
       self.txt_description.place(x=180,y=200,width=500,height=140)
       ...
       lbl_search_courseName=Label(self.root,text=" Serach By | Course Name",font=("goudy old style",20,"bold"),bg="white").place(x=850,y=80)
       txt_search_courseName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",20,"bold"),bg="lightyellow").place(x=1160,y=80,width=180)
       ...
       self.CourseTable=ttk.Treeview(self.c_Frame,columns=("cid","name","duration","charges","description"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)   # set columns
       ...
       self.CourseTable.column("cid",width=120)
       self.CourseTable.column("name",width=120)
       self.CourseTable.column("duration",width=100)
       self.CourseTable.column("charges",width=100)
       self.CourseTable.column("description",width=900)
